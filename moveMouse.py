...
def moveEdge():   
    ...
    imagem1 = pyautogui.locateCenterOnScreen("edge.wan", confidence=0.7, grayscale=False)
...
def moveBlueStacks():      
    imagem2 = pyautogui.locateCenterOnScreen("blueStacks.wan", confidence=0.7, grayscale=False)
